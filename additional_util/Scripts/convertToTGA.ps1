...
gimp-console-2.10 -idf --batch-interpreter python-fu-eval -b "import sys;sys.path=['.']+sys.path;import icon_generator;icon_generator.run('../','../../GODTextures')" -b "pdb.gimp_quit(1)"
